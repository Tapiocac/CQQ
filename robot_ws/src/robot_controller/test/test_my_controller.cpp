...
#include "test_my_controller.hpp"

using robot_controller::CMD_MY_ITFS;
using robot_controller::control_mode_type;
using robot_controller::STATE_MY_ITFS;

class MyControllerTest : public MyControllerFixture<TestableMyController>
{
};

TEST_F(MyControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(MyControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(MyControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(MyControllerTest, update_success)
{
  SetUpController();
...
TEST_F(MyControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(MyControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(MyControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(MyControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(MyControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(MyControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(MyControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
