...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_MY_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_MY_CONTROLLER_HPP_
...
using ControllerStateMsg = robot_controller::MyController::ControllerStateMsg;
using ControllerReferenceMsg = robot_controller::MyController::ControllerReferenceMsg;
using ControllerModeSrvType = robot_controller::MyController::ControllerModeSrvType;
...
class TestableMyController : public robot_controller::MyController
{
  FRIEND_TEST(MyControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(MyControllerTest, activate_success);
  FRIEND_TEST(MyControllerTest, reactivate_success);
  FRIEND_TEST(MyControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(MyControllerTest, test_update_logic_fast);
  FRIEND_TEST(MyControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = robot_controller::MyController::on_configure(previous_state);
...
class MyControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_my_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_my_controller/set_slow_control_mode");
  }
...
protected:
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_my_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableMyController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_MY_CONTROLLER_HPP_
